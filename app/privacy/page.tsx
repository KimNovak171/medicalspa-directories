...
export const metadata: Metadata = {
  title: "Privacy Policy | Medical Spa Directories",
  description:
    "Privacy policy for MedicalSpaDirectories.com. How we collect, use, and protect your information when you use our medical spa directory.",
  alternates: {
    canonical: "/privacy",
    languages: {
      "en-us": "https://medicalspadirectories.com/privacy",
    },
  },
  openGraph: {
    title: "Privacy Policy | Medical Spa Directories",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-slate mt-10 max-w-3xl prose-headings:font-semibold prose-headings:text-navy prose-a:text-teal prose-a:no-underline hover:prose-a:underline">
        <section className="space-y-4 text-sm text-slate-700">
          ...
          <p>
            MedicalSpaDirectories.com (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) operates a directory website that helps clients find and compare medical spas and aesthetic practices across the United States and Canada. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>

          <h2 className="text-lg font-semibold text-navy">2. Information We Collect</h2>
          <p>
            We may collect information that you provide directly, such as when you contact us, submit a form, or sign up for a featured listing. This may include your name, email address, phone number, practice or business details, and any message content. We also automatically collect certain technical information when you visit our site, such as your IP address, browser type, device information, and pages visited, which may be collected through cookies or similar technologies.
          </p>
          ...
          <p>
            Our directory displays information about practices that we obtain from public sources (such as Google Maps) or that is provided by business owners. Listing details (e.g., name, address, phone, website) are shown to help users compare options. If you are a practice owner and wish to update or remove your listing, contact us at hello@directoriesnetwork.com.
          </p>
