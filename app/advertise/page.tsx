...
export const metadata: Metadata = {
  title: "Advertise | Get Your Practice in Front of Clients",
  description:
    "Featured and premium listings on MedicalSpaDirectories.com. Reach clients actively searching for medical spas, aesthetic treatments, laser services, injectables, and skin care across the United States.",
  alternates: {
    canonical: "/advertise",
    languages: {
      "en-us": "https://medicalspadirectories.com/advertise",
    },
  },
  openGraph: {
    title: "Advertise | Get Your Practice in Front of Clients",
    description:
      "A featured listing puts your practice at the top of your city directory section and in front of high-intent visitors at the moment they are choosing a medical spa or aesthetic provider.",
    url: "/advertise",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "MedicalSpaDirectories.com advertise page preview",
      },
    ],
  },
};
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold text-navy sm:text-4xl">
          Get Your Practice in Front of Clients Who Are Ready to Book
        </h1>
        <p className="max-w-3xl text-sm text-slate-600">
          MedicalSpaDirectories.com is visited by clients actively searching for
          medical spas, laser treatments, injectables, and skin care across the United States. A featured listing puts
          your practice at the top of your city directory section and in front of
          high-intent visitors at the moment they are choosing an aesthetic or medical spa provider.
        </p>
      </header>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        <article className="rounded-xl border border-surface-muted bg-surface p-6 shadow-sm">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-slate-600">
            ...
            <li>Included in the Featured Medical Spas section on the homepage</li>
